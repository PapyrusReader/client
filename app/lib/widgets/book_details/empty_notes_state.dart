    ...
    return Padding(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.note_outlined, size: 64, color: colorScheme.onSurfaceVariant.withValues(alpha: 0.5)),
            ...
            FilledButton.icon(onPressed: onAddNote, icon: const Icon(Icons.add), label: const Text('Add note')),
          ],
        ),
      ),
    );
